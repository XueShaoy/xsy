---
title: "本地 text-to-SQL 的 RAG 实践：检索路由 + 权威源精读"
subtitle: "为什么不做经典 RAG，以及 BM25 + 向量混合检索的工程落地"
date: 2026-07-03T12:00:00+08:00
draft: false
author: "Shaoyang"
description: "深度拆解一套面向数分场景的本地 text-to-SQL 方案：分层知识资产、混合检索路由、防幻觉约束，以及从索引构建到在线查询的完整实现。"
...
回到开头的问题：**本地 text-to-SQL 的 RAG 应该怎么做？**
...
| 运行时 | Python 3.11+，本地 CLI + 可选 HTTP daemon |
